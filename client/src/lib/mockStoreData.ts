...
export const mockStores: Store[] = [
  ...
  {
    id: "store-007",
    name: "Reebok Kolkata Park Street",
    region: "East Zone",
    city: "Kolkata",
    timezone: "Asia/Kolkata",
    owner: "Anjali Gupta",
    ...
    email: "kolkata.park@reebok.com",
    openingHours: "10:00 AM - 9:00 PM",
  },
  {
    id: "store-008",
    name: "Nike Chennai T Nagar",
    region: "South Zone",
    city: "Chennai",
    timezone: "Asia/Kolkata",
    owner: "Priya Sharma",
    ...
    address: "Express Avenue, T Nagar, Chennai",
    phone: "+91 44 8901 2345",
    email: "chennai.tnagar@nike.com",
    openingHours: "10:00 AM - 10:00 PM",
  },
  {
    id: "store-009",
    name: "Puma Ahmedabad CG Road",
    region: "West Zone",
    city: "Ahmedabad",
    timezone: "Asia/Kolkata",
    owner: "Kavita Desai",
  ...
  {
    id: "store-013",
    name: "Puma Bangalore Whitefield",
    region: "South Zone",
    city: "Bangalore",
    timezone: "Asia/Kolkata",
    owner: "Priya Sharma",
    ...
    email: "bangalore.whitefield@puma.com",
    openingHours: "10:00 AM - 10:00 PM",
  },
  {
    id: "store-014",
    name: "Nike Jaipur MI Road",
    region: "North Zone",
    city: "Jaipur",
    timezone: "Asia/Kolkata",
    owner: "Vikram Malhotra",
    ...
    screensTotal: 4,
    status: "active",
    tags: ["Street Store", "Tourist Area"],
    address: "MI Road, Jaipur",
    phone: "+91 141 4567 8901",
    email: "jaipur.miroad@nike.com",
    openingHours: "10:00 AM - 9:00 PM",
  },
  {
    id: "store-015",
    name: "Adidas Gurgaon Cyber Hub",
    region: "North Zone",
    city: "Gurgaon",
    timezone: "Asia/Kolkata",
    owner: "Vikram Malhotra",
    ...
    email: "gurgaon.cyberhub@adidas.com",
